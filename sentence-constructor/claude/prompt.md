...
### arabic Sentence Attempt
When the input is arabic text or arabizi, then the student is making an attempt at the anwser
...
- the table of of vocabular should only have the following columns: arabic, Arabizi, English
